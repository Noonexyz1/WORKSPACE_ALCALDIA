export enum UrlsProperties {
  PATH_LOGIN = 'http://localhost:8081/autenticacion/iniciarSesion',
  PATH_CHANCE_PASS = 'http://localhost:8081/autenticacion/cambiarPass',
  PATH_CLOSE_LOGIN = 'http://localhost:8081/autenticacion/cerrarSesion',
