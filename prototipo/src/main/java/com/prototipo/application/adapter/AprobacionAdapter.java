...
public class AprobacionAdapter implements AprobacionService {
    ...
    @Override
    public PaginableOut<Solicitud> listaDeSolicitudesPendientesServiceByIdSoli(PaginableIn paginableIn) {
        PaginableOut<SolicitudDto> solicitudDtos = aprobacionAbstract
    ...
    @Override
    public PaginableOut<Autorizacion> listaDeSolicitudesAutoriServiceByIdSoli(PaginableIn paginableIn) {
        PaginableOut<AutorizacionDto> soliAutorizadas = aprobacionAbstract
    ...
    @Override
    public PaginableOut<Finalizacion> listaDeSolicitudesFinalizadasServiceByIdSoli(PaginableIn paginableIn) {
        PaginableOut<FinalizacionDto> finalizacionDtoList = aprobacionAbstract
                .listaDeAprobacionesFinalizadasAbstractPageByIdSoli(paginableIn);
